...
<head>
	<title><?=$title?></title>
	<link href='<?=base_url()?>templates/tmpl_metu/images/favicon.ico' rel='icon' type='image/x-icon'/>
	<meta name="description" content="__description__" />
	<meta name="keywords" content="__keywords__" />
	<link href="<?=base_url()?>templates/tmpl_metu/css/style.css" rel="stylesheet" type="text/css" />
	<link href="<?=base_url()?>templates/tmpl_metu/css/general.css" rel="stylesheet" type="text/css" />
	<link href="<?=base_url()?>templates/tmpl_metu/css/admin.css" rel="stylesheet" type="text/css" />
