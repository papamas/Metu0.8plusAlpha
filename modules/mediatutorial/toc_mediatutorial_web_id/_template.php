...
// global variables
   ...
   var totalPosts =<?=$total_news?>; //Total number of posts in the blog.
...
function loadtoc(json) {
   ...
   // this functions reads all postdata from the json-feed and stores it in arrays
      if ("entry" in json.feed) {
         ...
         nextjsoncall.setAttribute("src", "<?=$website?>feeds/posts/summary?start-index=" + startindex + "&max-results=<?=$total_news?>&alt=json-in-script&callback=loadtoc");
...
<script src="<?=$website?>feeds/posts/summary?alt=json-in-script&max-results=<?=$total_news?>&callback=loadtoc" type="text/javascript"></script>